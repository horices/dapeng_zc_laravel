            ...
            <div class="sub_main_one">
                <div class="main_left">
                    ...
                    <div class="div_input_one">
                        ...
                        <a class="common-button dblock fleft combg2 ml5 ajaxLink" data="{mobile:$('#mobile').val(),client_submit:'PC'}" href="{{url('hasRegistration')}}" callback="hasRegistration">下一步</a>
                    </div>
                    <div id="show-input">
                        <div class="div_input_one">
                            <label class="col-md-2 control-label" for="input01">
