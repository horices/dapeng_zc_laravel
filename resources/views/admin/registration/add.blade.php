...
//                        isAjax = 1;
                ...
                watch:{
                    'userPayInfo.rebate_id':function () {
                        var _this = this;
                        if(_this.userPayInfo.rebate_id == 0){
                            ...
                            //用each获取每个元素
                            $.each(_this.rebateList, function(i, val){
                                if(_this.userPayInfo.rebate_id == val.id){
                                    console.log(_this.userPayInfo.rebate_id);
                                    console.log(val.id);
        ...
        <div id="container" class="sub_main">
                ...
                <div class="main_left">
                    <div id="show-input">
                        ...
                        <div class="div_input_one">
                            ...
                            <select class="form-control fleft" v-model="userPayInfo.rebate_id" name="rebate_id" :disabled="hasUser">
            ...
            <div class="sub_main_two">
                ...
                <div class="div_input_one" style="margin: 0 auto; text-align: center;">
                    ...
                    <input type="hidden" name="client_submit" value="PC" />
                    <button class="btn btn-primary ajaxSubmit" type="button" url="{{route('admin.registration.add')}}">确认提交</button>
                </div>
            </div>
            </form>
        </div>
