        ...
        <table class="table">
            ...
            @foreach($list as $user)
                <tr class="">
                    ...
                    <td><a href="{{ route("admin.roster.list",\Illuminate\Support\Facades\Input::merge([$user_id_str=>$user->uid,'show_statistics'=>1])->merge($url_data)->merge(['keywords'=>''])->all()) }}">查看</a></td>
                </tr>
            @endforeach
            <tr>
                <td colspan="10">
